...
The test module demonstrates deprecated APIs that compile with warnings on Boot 3.5.16 but fail to compile on Boot 4.0:
...
- **DeprecatedUsageTest.java**: Tests that the deprecated APIs work correctly on Boot 3.5.16
