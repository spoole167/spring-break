...
The test module contains Jackson 2.x code that compiles cleanly on Spring Boot 3.5.16 but fails to compile on Boot 4.0:
...
**On Spring Boot 3.5.16**: Both tests pass; the code compiles and runs.
